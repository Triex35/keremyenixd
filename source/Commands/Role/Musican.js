...
module.exports = {
	config: {
		aliases: ["müzisyen", "musican"],
		name: "musican",
        help: "musican [@Chewy/ID]",
		enabled: true
	},
	...
	run: async ({ client, message, args, embed, guild, author }) => {
        ...
        member.roles.add(config.Roles.Member.Musician)
        ...
        message.reply({ embeds: [new MessageEmbed()
            ...
            .setDescription(`
${member} isimli kullanıcı sunucumuzun müzisyen ekibine katıldı!
            `)
            ] })
...
\`Verilen Rol:\` ${config.Roles.Member.Musician}
